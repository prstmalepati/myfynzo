...
export async function generatePortfolioReport(data: ReportData): Promise<Blob> {
  ...
  try {
    ...
    doc.addImage('/logo-transparent.png', 'PNG', margin, 30, 22, 22);
  } catch {
    // Fallback: draw a teal circle with "m" if image fails
    doc.setFillColor(...PRIMARY);
    doc.circle(margin + 11, 41, 11, 'F');
    doc.setFont('helvetica', 'bold');
    doc.setFontSize(16);
    doc.setTextColor(255, 255, 255);
    doc.text('m', margin + 7.5, 45.5);
  }
  ...
  doc.setFontSize(20);
  doc.setTextColor(255, 255, 255);
  doc.text('myfynzo', margin + 28, 44);
  doc.setFontSize(7);
  doc.setTextColor(...PRIMARY);
  doc.text('YOUR WEALTH. REIMAGINED BY AI.', margin + 28, 50);
  ...
  doc.text('Generated by myfynzo — Your Wealth. Reimagined by AI.', margin, H - 20);
  doc.text('www.myfynzo.com', margin, H - 14);
  ...
  doc.setFillColor(...PRIMARY);
  doc.rect(0, 0, W, 3, 'F');
  try { doc.addImage('/logo-transparent.png', 'PNG', W - margin - 10, 6, 8, 8); } catch {}
  doc.setFont('helvetica', 'normal');
  doc.setFontSize(7);
  doc.setTextColor(...GRAY);
  doc.text('myfynzo · Portfolio Report', margin, 10);
  doc.text(data.date, W - margin - 22, 10);
  ...
  doc.text(`Generated by myfynzo — Your Wealth. Reimagined by AI. — ${data.date}`, margin, H - 14);
  try { doc.addImage('/logo-transparent.png', 'PNG', W - margin - 8, H - 22, 6, 6); } catch {}
