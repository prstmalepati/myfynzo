    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-16 pb-12 px-6 bg-gradient-to-b from-slate-50 to-white">
        <div className="max-w-5xl mx-auto text-center">
          <p className="text-sm font-semibold text-primary tracking-wide uppercase mb-3">myfynzo Blog</p>
          <h1 className="text-3xl lg:text-4xl font-bold text-secondary font-display tracking-tight mb-4">
